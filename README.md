...
| Demo | Creator | What it is | Link(s) | Status | Notes |
|---|---|---|---|---|---|
| **Studio Ghibli VR Scenes** | Nick Pittom (Red of Paw / Fire Panda) | Three lovingly recreated, explorable film scenes — Kamaji's **boiler room** (*Spirited Away*), the rainy **bus stop & Catbus** (*My Neighbor Totoro*, interactive), and the flower **meadow** (*Howl's Moving Castle*) | [Mega mirror (all 3)](https://mega.nz/file/swMSUArD#d8lZ2yA4fALsvLGmkM79KsESZhIS3rJMF1v5RP2wY0A) · [Totoro on archive.org](https://archive.org/details/my-neighbor-totoro-the-bus-stop-rt-6.0.1.0) · [RoadToVR preview](https://www.roadtovr.com/preview-ghibli-vr-offers-virtual-tour-worlds-beloved-anime/) | 🟡 | Fan-made for Rift + Vive (2016). **Removed at Studio Ghibli's request** — preserved via community mirror. Same creator as *Colosse*. |
